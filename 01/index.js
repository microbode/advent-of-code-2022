...
const _getTotalCaloriesByElf = caloriesList => {
  let caloriesByElf = [];
  let caloriesByElvesIndex = 0;
  let oneElfCalories = 0;
  for (const calories of caloriesList) {
    if (calories === "") {
      caloriesByElf[caloriesByElvesIndex] = oneElfCalories;
      oneElfCalories = 0;
      caloriesByElvesIndex += 1;
      continue;
    }
    oneElfCalories += parseInt(calories);
  }
